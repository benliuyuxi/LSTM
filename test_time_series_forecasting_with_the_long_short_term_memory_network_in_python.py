...
print("transform data to be stationary ... ", end="", flush=True)
raw_values = series.values
diff_values = difference(raw_values, 1)
print("Done")

# transform data to be supervised learning
print("Transform data to be supervised learning ... ", end="", flush=True)
supervised = timeseries_to_supervised(diff_values, 1)
supervised_values = supervised.values
print("Done")

# split data into train and test-sets
print("split data into train and test-sets ... ", end="", flush=True)
train, test = supervised_values[0:-12], supervised_values[-12:]
print("Done")

# transform the scale of the data
print("transform the scale of the data ... ", end="", flush=True)
